  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto py-8">
      <div>
        ...
        <p className="text-muted-foreground">Find answers to common questions and learn how to repair your devices</p>
      </div>
        ...
        <div className="flex flex-wrap gap-2">
          <button
            ...
            className={`px-4 py-2 rounded-lg text-sm font-medium transition ${
              selectedCategory === "" ? "bg-orange-600 text-white" : "bg-muted text-muted-foreground hover:bg-muted/80"
            }`}
          >
            All
          </button>
