...
export async function POST(req: NextRequest) {
  try {
    ...
    // Special handling for warranty check payments - no workOrder needed
    let workOrderId = data.workOrderId;
    if (data.metadata?.service === "warranty-check") {
      // For warranty checks, workOrderId remains undefined
